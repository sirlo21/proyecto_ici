...
<div class="form-group col-sm-12">
   <div class="pull-right">
    ...
    <a href="{!! route('farmacias.ver_dispositivos',[$establecimiento->id,$farmacia->id]) !!}"  class="btn btn-danger">Cancelar <i class="glyphicon glyphicon-remove"></i></a>
    </div>
</div>
                    ...
                    @foreach($petitorios as $id => $petitorio)
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                type="checkbox" 
                                value="{{ $petitorio->id }}" 
                                {{ $farmacia->petitorios->pluck('id')->contains($petitorio->id) ? 'checked' : '' }}
                                name="petitorios[]">
                            </td>
                        </tr>
