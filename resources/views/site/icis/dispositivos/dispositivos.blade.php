    ...
    @if ($establecimiento_id !== Auth::user()->establecimiento_id)
        <section class="content-header">
            ...
            @else
                ...
                <!--h4>
                    <a onclick="addForm()" class="btn btn-primary pull-left" style="margin-top: -8px;">
                    Recetas Atendidas</a>
                </h4-->
        ...
        <div class="content">
            ...
            <div class="box box">
                <div class="box-body">
                    ...
                    @include('site.icis.dispositivos.form')
...
<!-- Bootstrap core JavaScript
    ...
    <script type="text/javascript">
      ...
      function addForm() {
        ...
        $('#modal-formu form')[0].reset();
        $('.modal-title').text('Receta');
      }
...
//                        data : $('#modal-form form').serialize(),
        ...
        $(function(){
            $('#modal-formu form').validator().on('submit', function (e) {
                if (!e.isDefaultPrevented()){
                    var id = $('#id').val();
