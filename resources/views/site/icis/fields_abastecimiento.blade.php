...
<div class="form-group col-sm-6">
    ...
    {!! Form::number('cpma', null, ['class' => 'form-control', 'autofocus'=>'autofocus']) !!}
</div>
...
<div class="form-group col-sm-6">
    ...
    <div class="input-group date">
      <div class="input-group-addon">
        ...
        {!! Form::date('fecha_vencimiento', null, ['class' => 'form-control pull-right'  ]) !!}  
    </div>    
</div>
...
<div class="form-group col-sm-12">
    ...
    @if ($abastecimiento->tipo_dispositivo_id==1)
        <a href="{!! route('abastecimiento.cargar_medicamentos',[0,$abastecimiento->establecimiento_id]) !!}" class="btn btn-danger">Cancelar</a>
    
    @else
    
        <a href="{!! route('abastecimiento.cargar_dispositivos',[0,$abastecimiento->establecimiento_id]) !!}" class="btn btn-danger">Cancelar</a>
    @endif
